...
func (t *SimpleChaincode) invoke(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	compositeKey, compositeErr := stub.CreateCompositeKey(compositeIndexName, []string{A, op_A, args[3], txid})
	if compositeErr != nil {
	...
	// Create the composite key that will allow us to query for all deltas on a particular variable
	compositeKey1, compositeErr1 := stub.CreateCompositeKey(compositeIndexName, []string{B, op_B, args[3], txid})
